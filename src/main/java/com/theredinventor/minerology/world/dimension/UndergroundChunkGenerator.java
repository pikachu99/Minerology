...
public class UndergroundChunkGenerator extends NoiseChunkGenerator<UndergroundGenSettings> {
    private final double[] field_222573_h = this.func_222572_j();

    public UndergroundChunkGenerator(IWorld worldIn, BiomeProvider provider, UndergroundGenSettings settingsIn) {
        super(worldIn, provider, 4, 8, 255, settingsIn, false);
    }
